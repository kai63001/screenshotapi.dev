...
<div class="gap-4 grid">
	...
	<div class="bg-white p-5 rounded-md">
		...
		<p class="text-mute mt-2">
			You have taken <span class="font-bold">{quota.screenshots_taken}</span> screenshots this month. Your plan includes
			<span class="font-bold">{quota.included_screenshots}</span> screenshots.
            <a href="/subscription" class="text-red-600 hover:text-red-800 hover:underline">Consider upgrading</a> for more!
		</p>
        <div class="my-1">

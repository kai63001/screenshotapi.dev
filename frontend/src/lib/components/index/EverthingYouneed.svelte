<script>
	...
	const list = [
		...
		{
			title: 'Exceptional Image Fidelity',
			description:
		...
		{
			title: 'Tailored Developer Feedback',
			description:
		...
		{
			title: 'Adjustable Capture Timing',
			description:
		...
		{#each list as item}
			<div>
				<div class="flex items-center space-x-2">
                    <Icon class="text-3xl text-primary" icon="solar:verified-check-bold" />
